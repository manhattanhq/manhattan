...
// instantiate experienced object
...
$experienced->created = date('Y-m-d H:i:s');

// create the experienced
if($experienced->create()){
    echo "experienced was created.";
}

// if unable to create the experienced, tell the user
else{
    echo "Unable to create experienced.";
}
?>
